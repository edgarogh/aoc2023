...
function get_name()
    return "AOC 2023 Edgar"
end

function get_description()
    return { 
        "*aoc* is an simple input whose values correspond to bytes of the input.txt file for this year's AOC."
    }
end

-- cute lil christmas tree PCB UwU
function get_board()
    return [[
        ....##########....
        ...############...
...
function get_data()
    input = {}
    for time=1,#aoc_input do
        input[time] = string.byte(aoc_input, time)
    end

    create_terminal("aoc", "0", TYPE_XBUS, DIR_INPUT, { input })
end
